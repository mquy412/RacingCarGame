...
public class SelectCarUIHandler : MonoBehaviour
{
    ...
    {
        GameObject.FindGameObjectWithTag("SFX").GetComponent<SoundSFX>().SFXStop();
        GameObject.FindGameObjectWithTag("Music").GetComponent<SoundGame>().clickButton();
        GameManager.instance.ClearDriversList();
        GameManager.instance.AddDriverToList(1, "You", carDatas[selectedCarIndex].CarUniqueID, false);
